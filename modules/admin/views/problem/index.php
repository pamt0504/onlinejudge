...
<div class="problem-index">
    ...
    <hr>
    <p>
        <a id="available" class="btn btn-primary" href="javascript:void(0);" data-toggle="tooltip" data-placement="top" >
            Public
        </a>
        <a id="reserved" class="btn btn-info" href="javascript:void(0);" data-toggle="tooltip" data-placement="top" >
            Hidden
        </a>
        <a id="private" class="btn btn-warning" href="javascript:void(0);" data-toggle="tooltip" data-placement="top" >
            Private
        </a>
        <a id="delete" class="btn btn-danger" href="javascript:void(0);" data-toggle="tooltip" data-placement="top" >
            Delete
        </a>
    </p>
