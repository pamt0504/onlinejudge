...
<div class="contest-view">
    ...
    <p>
        ...
        <?= Html::a(Yii::t('app', 'Source Print Queue'), ['/print', 'id' => $model->id], ['class' => 'btn btn-default', 'target' => '_blank']) ?>
        <?php endif; ?>
        <?= Html::a(Yii::t('app', 'Clarification'), ['clarify', 'id' => $model->id], ['class' => 'btn btn-warning', 'target' => '_blank']) ?>
        <?= Html::a(Yii::t('app', 'Submit records'), ['status', 'id' => $model->id], ['class' => 'btn btn-success', 'target' => '_blank']) ?>
        <?= Html::a(Yii::t('app', 'Calculate rating'), ['rated', 'id' => $model->id], ['class' => 'btn btn-info']) ?>
        <?= Html::a(Yii::t('app', 'Contestant'), ['register', 'id' => $model->id], ['class' => 'btn btn-primary']) ?>
    ...
    <p>
        ...
        <?= Html::a('Scoreboard', ['/contest/standing2', 'id' => $model->id], ['class' => 'btn btn-default', 'target' => '_blank']) ?>
        <?php if ($model->scenario == Contest::SCENARIO_OFFLINE): ?>
        <?php Modal::begin([
        ...
        <div class="form-group">
            <?= Html::submitButton(Yii::t('app', 'Open Scoreboard'), ['class' => 'btn btn-primary']) ?>
        </div>
