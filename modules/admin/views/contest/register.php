...
<?php if ($model->scenario == Contest::SCENARIO_OFFLINE): ?>
    <?php Modal::begin([
        ...
        <p class="text-danger">Note: Repeated use of this feature in the same contest will delete previously generated accounts, do not do this after the contest has started.</p>
            ...
            'buttons' => [
                'delete' => function ($url, $model, $key) use ($contest_id) {
                    $options = [
                        ...
                        'data-confirm' => "Deleting this item will also delete the user's submission record in this contest. Are you sure you want to delete it?",
                        'data-method' => 'post',
                        'data-pjax' => '0',
                    ];
