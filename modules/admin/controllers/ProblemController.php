...
class ProblemController extends Controller
{
    ...
    public function actionCreateFromPolygon()
    {
        if (Yii::$app->request->isPost) {
            ...
            if (!empty($id)) {
                ...
                Yii::$app->session->setFlash('error', Yii::t('app','Please fill in the form'));
            }
            return $this->redirect(['index']);
        }
    ...
    public function actionSpj($id)
    {
        ...
        if (Yii::$app->request->isPost) {
            ...
            if ($compileRes) {
                Yii::$app->session->setFlash('error', 'Compile Error: ' . implode("\n", $compileInfo));
            } else {
    ...
    public function actionDelete($id)
    {
        ...
        try {
            ...
            Yii::$app->session->setFlash('error', Yii::t('app', 'Deleted failed') . $e->getMessage());
            return $this->redirect(['index']);
        }
        $model->delete();
