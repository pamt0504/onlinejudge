...
<div class="print-source-view">
    ...
    <?php if (Yii::$app->user->identity->role === \app\models\User::ROLE_ADMIN): ?>
        <div class="alert alert-warning alert-dismissible fade in hidden-print" role="alert">
            ...
            <p>Tip: You can use the browser print function to print quickly (Example: Chrome browser can use the mouse "right click" - "Print" on the page, other browsers, please use the search engine to obtain the usage method).</p>
        </div>
    <?php endif; ?>
    <hr>
