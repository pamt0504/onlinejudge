...
<div class="print-source-index">
    ...
    <p>
        <?= Html::a('Print Source Code', ['create', 'id' => $contest->id], ['class' => 'btn btn-success']) ?> If you need to print the code for teammates to view, please click this button to submit, and the staff will print it and send it to the front of the team.
    </p>
