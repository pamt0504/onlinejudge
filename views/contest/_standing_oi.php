...
<table class="table table-bordered table-rank" style="margin-top: 15px">
    ...
    <tr>
        ...
        <th width="80px">Total score re-check</th>
        <?php else: ?>
        ...
        <th width="80px">
            Time
            <span data-toggle="tooltip" data-placement="top" title="Only count the total time required to pass all the problems during the contest (unit: minutes)">
