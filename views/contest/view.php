        ...
        <table class="table table-bordered table-problem-list">
            ...
            <tr>
                ...
                if ($model->isContestEnd()) {
                    echo "<th width='100px'>".Yii::t('app','Problem ID')."</th>";
                }
                ?>
                <th><?= Yii::t('app', 'Problem Name') ?></th>
                <th width="100px"><?= Yii::t('app', 'Accepted/Submissions') ?></th>
                <th width="80px"><?= Yii::t('app','Status')?></th>
            </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <th>
                        ...
                        <?php elseif ($loginUserProblemSolvingStatus[$p['problem_id']] == \app\models\Solution::OJ_AC): ?>
                            <span class="glyphicon glyphicon-ok text-success" title="Accepted"></span>
                        <?php elseif ($loginUserProblemSolvingStatus[$p['problem_id']] < 4): ?>
                            <span class="glyphicon glyphicon-question-sign text-muted" title="Pending"</span>
                        <?php else: ?>
